package de.davelee.trams.simulation;
    ...
    public LinkedList<Message> getMessages ( String folder, String date, String type ) {
        ...
        for ( int i = 0; i < theMessageQueue.size(); i++ ) {
            ...
            if ( date.equalsIgnoreCase("All Dates") ) {
                ...
                if ( folder.equalsIgnoreCase(theMessageQueue.get(i).getFolder().getDisplayName())) {
                    messages.add(theMessageQueue.get(i));
                }
            }
            else if ( date.equalsIgnoreCase(theMessageQueue.get(i).getDate().split(" at")[0]) && folder.equalsIgnoreCase(theMessageQueue.get(i).getFolder().getDisplayName()) ) {
                messages.add(theMessageQueue.get(i));
            }
        }
