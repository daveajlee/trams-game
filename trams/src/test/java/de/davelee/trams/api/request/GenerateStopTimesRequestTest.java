...
public class GenerateStopTimesRequestTest {
    ...
    public void testCreateRequest() {
        ...
        stopPatternRequest.setStopNames(new String[] { "City Centre" });
        stopPatternRequest.setStoppingTimes(new int[] { 0 });
        stopPatternRequest.setDistances(new int[] { 0 });
        generateStopTimesRequest.setStopPatternRequest(stopPatternRequest);
        ...
        assertNotNull(generateStopTimesRequest.getStopPatternRequest());
        ...
        assertEquals("GenerateStopTimesRequest(company=Lee Company, stopPatternRequest=StopPatternRequest(stopNames=[City Centre], distances=[0], stoppingTimes=[0]), routeNumber=1A, startTime=06:00, endTime=23:00, frequency=15, validFromDate=12-12-2020, validToDate=11-12-2021, operatingDays=Monday,Tuesday,Wednesday)", generateStopTimesRequest.toString());
    }
